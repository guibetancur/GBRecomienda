...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { calls: @recommendation.calls, description: @recommendation.description, name: @recommendation.name, score: @recommendation.score, url: @recommendation.url } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { calls: @recommendation.calls, description: @recommendation.description, name: @recommendation.name, score: @recommendation.score, url: @recommendation.url } }
